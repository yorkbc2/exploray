<template>
  <div class="tours">
    <app-header
      title="Сравнивай и выбирай лучшее"
      :breads="{'/': 'Главная', '/tours': 'Путешествия'}"
      background="/images/tours_bg.jpg"
    >
      <input-group>
        ...
        <div class="input-group__element">
          <img src="/images/traveler.png" alt class="icon" width="30px" height="30px">
          <input-check-picker
            :items="[
                        'Россия',
                        'Украина',
